  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        />
        <Route
          path="/internal-preview/:token"
          element={<InternalContentPreviewPage />}
        />
        <Route
          path="/client-review/:token"
          element={<ClientReviewLegacyRedirectPage />}
        />
        ...
        />
        <Route
          path="/client-portal/:clientToken/login"
          element={<ClientPortalLoginPage />}
        />
        <Route
          path="/client-portal/:clientToken"
          element={<ClientPortalPage />}
        />
        <Route
          path="/client-portal/:clientToken/reviews/:draftId"
          element={<ClientPortalReviewPage />}
        />
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <FeatureRoute feature="leave_requests">
                <LeavePage />
              </FeatureRoute>
            </ProtectedRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <FeatureRoute feature="social_media">
                <CampaignsPage />
              </FeatureRoute>
            </ProtectedRoute>
          }
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              ...
              >
                <FeatureRoute feature="media_dashboard">
                  <MediaDashboardPage />
                </FeatureRoute>
              </RoleRoute>
            </ProtectedRoute>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <RoleRoute roles={["admin", "manager", "media_team"]}>
                <FeatureRoute feature="media_dashboard">
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <FeatureRoute feature="ai_workspace">
                <AIWorkspacePage />
              </FeatureRoute>
            </ProtectedRoute>
          }
          ...
          element={
            <ProtectedRoute>
              <RoleRoute roles={["admin", "org_admin", "super_admin"]}>
                <FeatureRoute feature="admin_dashboard">
                  <AdminDashboardPage />
                </FeatureRoute>
              </RoleRoute>
            </ProtectedRoute>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <RoleRoute roles={["admin", "org_admin", "manager", "hr"]}>
                <FeatureRoute feature="knowledge_base">
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <FeatureRoute feature="duty_roster">
                <DutyRosterViewPage />
              </FeatureRoute>
            </ProtectedRoute>
          }
