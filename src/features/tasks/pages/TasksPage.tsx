...
export default function TasksPage() {
  ...
  const [boardMode, setBoardMode] = useState<"organization" | "mine">(
    "organization",
  );
          ...
          <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
            <div className="min-w-0">
              ...
              <p className="mt-2 text-sm text-white/50">
                Shared professional workflow cards for the organization.
              </p>
            </div>
            ...
            <section className="min-w-0 rounded-2xl border border-white/10 bg-white/5 p-5">
              ...
              <div className="mb-5 rounded-2xl border border-white/10 bg-black/30 px-4 py-3">
                <div className="flex items-center gap-2 text-sm text-white/60">
                  <LayoutGrid size={14} />
                  <span>
                    Cards now support searchable invited users, time tracking,
                    and checklists.
                  </span>
                </div>
              </div>
