  ...
  async function handleSaveBranding() {
    ...
    try {
      ...
      const saved = await updateOrganizationBranding({
        ...
        appName: branding.app_name ?? branding.brand_name ?? selectedOrg.name,
        ...
        buttonColor: branding.button_color ?? branding.accent_color ?? "#f97316",
        buttonTextColor: branding.button_text_color ?? "#ffffff",
        buttonHoverColor: branding.button_hover_color ?? "#ea580c",
        linkColor: branding.link_color ?? branding.accent_color ?? "#fb923c",
        linkHoverColor: branding.link_hover_color ?? "#fdba74",
        inputFocusColor:
          branding.input_focus_color ?? branding.accent_color ?? "#f97316",
