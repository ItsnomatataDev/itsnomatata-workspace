...
export default function ManageLocationsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-white text-gray-950 shadow-xl">
        <div className="flex items-center justify-between border-b border-gray-200 px-5 py-4">
          ...
          <button
            ...
            className="rounded-full p-1 text-gray-700 transition hover:bg-gray-100 hover:text-gray-950"
          >
            <X size={20} />
          </button>
        </div>
